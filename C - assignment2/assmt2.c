...
*/ 
			...
			} else if (final < 100.00 && final >= 90.00) {
				
				printf(" "); 
			
			} else if (final < 90.00 && final >= 80.00) {
				
				printf("8");
			
			} else if (final < 80.00 && final >= 70.00) {
				
				printf(" ");
			
			} else if (final < 70.00 && final >= 60.00) {
				
				printf("6"); 
			
			} else if (final < 60.00 && final > 55.00) {
				
				printf(" ");
			
			} else if (final <= 55.00 && final >= 0.00) {
...
double individual_sound_level (double distance, double soundlevel) {
	...
	finalsoundlevel = soundlevel + 20.0*(log10(1/distance));   
